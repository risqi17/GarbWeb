                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="post" action="<?php echo base_url(). 'model/aksi_tambah'; ?>" enctype="multipart/form-data">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Tambahkan</button>
