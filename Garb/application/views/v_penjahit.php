            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Data Penjahit</h4>
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                       <?php 
										...
										?>
                                        <tr>
                                        	<td><?php echo $row->id_pjh; ?></td>
                                        	<td><?php echo $row->nama_pjh; ?></td>
                                        	<td><?php echo $row->email_pjh; ?></td>
                                        	<td><?php echo $row->jk_pjh; ?></td>
                                        	<td><?php echo $row->password_pjh; ?></td>
                                        	<td><?php if($row->ver_code == ''){
											echo "Aktif";
														}else{
											echo "Belum Aktif";
											} ?>
                                        	...
                                        	<td>
                                        		<?php if($row->ver_code != ''){
											?>
													<form method="post" action="<?php echo base_url(). 'penjahit/verifikasi'; ?>">
														<input type="hidden" name="username" value="<?php echo $row->id_pjh; ?>">
														<button type="submit" class="btn btn-info btn-fill" name="edit">&nbsp;Aktifkan</button>&nbsp;
													</form>
													<?php	} ?>
                                       			<a href="<?php echo base_url('penjahit/hapus')?>/<?php  echo $row->id_pjh; ?>"><button type="submit" class="btn btn-danger btn-fill" name="hapus" onClick="return doconfirm();">&nbsp;Hapus</button></a>
                                        	</td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
